...
What is the difference between filtering data before rendering and conditionally rendering inside map()?

### Question 3

How can you optimize search performance for 5000+ records?

### Question 4

What happens if useEffect dependency array is omitted?

### Question 5

How would you persist filter selections after page refresh?
